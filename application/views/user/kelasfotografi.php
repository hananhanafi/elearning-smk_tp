        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a href="<?= base_url('admin') ?>" style="font-size: 19px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center">SMK TANJUNG PRIOK</a>
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    ...
                    <h4 data-aos="fade-down" data-aos-duration="1700"><?php
                                                                        ...
                                                                        echo $data['user']['nama'];
                                                                        ?> Students</h3>
                        <h5>Mata Pelajaran Fotografi</h5>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/fotografi') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/camera.png" class="card-img-top" alt="alternate text" width="width" height="height" style="padding-bottom:0.5em;" />
                        <center>Kelas Fotografi</center>
                    </div>
                </a>
            </div>
