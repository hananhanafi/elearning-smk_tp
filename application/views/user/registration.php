...
<head>
    ...
    <title>E-LEARNING SMK TANJUNG PRIOK</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a href="<?= base_url('welcome') ?>" style="font-size: 19px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center">SMK TANJUNG PRIOK</a>
