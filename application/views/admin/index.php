            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="<?= base_url('admin') ?>" style="font-size: 19px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 25px;" class="fas fa-graduation-cap"></i> SMK TANJUNG PRIOK</a>
                        </div>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a style="font-size: 19px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 25px;" class="fas fa-graduation-cap"></i></a>
                    </div>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Halaman Dashboard Admin SMK TANJUNG PRIOK </p>
                                <div class="mt-4">
