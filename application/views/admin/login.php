    ...
    <div id="app">
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-fix overlay-gradient-bottom" data-background="https://i.ytimg.com/vi/lp5bNfA_yIw/maxresdefault.jpg">
                </div>
            </div>
        </section>
    </div>
